...
<body>
    ...
    <div class="question">
        <?php
            $sql = "SELECT * FROM questions WHERE id = 4";
    ...
    <div class="icons">
        <a href="config/save4.php?ket=sangat_puas"><input type="image" name="spuas" id="spic" src="assets/img/sgtpuas.png"></a>
        <h3 class="sp">Sangat Puas</h3>
        <a href="config/save4.php?ket=puas"><input type="image" name="puas" id="pic" src="assets/img/puas.png"></a>
        <h3 class="ps">Puas</h3>
        <a href="config/save4.php?ket=cukup_puas"><input type="image" name="cpuas" id="cpic" src="assets/img/ckppuas.png"></a>
        <h3 class="cp">Cukup Puas</h3>
        <a href="config/save4.php?ket=tidak_puas"><input type="image" name="tpuas" id="tpic" src="assets/img/marah.png"></a>
