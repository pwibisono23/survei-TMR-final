<?php 
    ...
    if(isset($_POST["addquestion"])){
        if(questionAdd($_POST) > 0){
            ...
            header("Location: survei-edit.php");
        } else {
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="#">
                                <div class="sb-nav-link-icon"><i class="fa-sharp fa-regular fa-wave-pulse"></i></div>
                                Activity Log
                            </a>
                </nav>
            </div>
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Pertanyaan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Edit Pertanyaan</li>
                        </ol>
                        
                        <h3 class="header2">Edit Pertanyaan</h3>

                        <div class="card-body">
                            <form action="" method="POST">
                                <a href="">Pertanyaan</a>
                                <input type="text" id="edit-question" name="edit-question">
                            </form>
                        </div>
                    </div>
                </main>
